...
python app.py
```
Open ([https://careercast-2.onrender.com/login](https://careercast-4.onrender.com/skill-gap-analysis)) in your browser.[deployment link upto 3rd milestone have to implemnet for 4th milestone]
